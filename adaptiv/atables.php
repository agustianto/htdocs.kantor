...
$query = mysql_query("select * from meta_angket where nim = '".$_SESSION['user']."'");
    ...
    */
    ...
    $vsm[0] = $perta[6] + $perta[11] + $perta[13] + $perta[17] + $perta[18] + $perta[21] + $perta[33] + $perta[47];
    $vsm[1] = $perta[4] + $perta[15] + $perta[28] + $perta[34];
    $vsm[2] = $perta[16] + $perta[19] + $perta[27] + $perta[30] + $perta[36];
    $vsm[3] = $perta[5] + $perta[7] + $perta[9] + $perta[23] + $perta[24] + $perta[43] + $perta[46];
    $vsm[4] = $perta[10] + $perta[14] + $perta[31] + $perta[32] + $perta[38] + $perta[40] + $perta[42] + $perta[44] + $perta[48] + $perta[49];
    $vsm[5] = $perta[2] + $perta[3] + $perta[12] + $perta[22] + $perta[29] + $perta[35] + $perta[50];
    $vsm[6] = $perta[26] + $perta[41] + $perta[45] + $perta[52] + $perta[53];
    $vsm[7] = $perta[8] + $perta[20] + $perta[25] + $perta[36] + $perta[39] + $perta[51];
...
                                                                                                                                                                                                                                                                                                                                                                                                                    type="submit" name="Submit" class="btn btn-primary btn-lg btn-block">Simpan</button>
                            </div>
                        </form>
                            <!-- /.table-responsive -->
                        </div>
